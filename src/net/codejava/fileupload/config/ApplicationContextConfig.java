...
public class ApplicationContextConfig {
    ...
    public DataSource getDataSource() {
    	...
    	dataSource.setUrl("jdbc:mysql://localhost:3308/learning");
    ...
    public CommonsMultipartResolver getCommonsMultipartResolver() {
    	...
    	multipartResolver.setMaxUploadSize(2097199520); // 20MB
    	multipartResolver.setMaxInMemorySize(99948576);	// 1MB
